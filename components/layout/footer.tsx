  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: "Career Advice", href: "/resources" },
      ],
    },
    {
      title: "For Employers",
    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase mb-4">{section.title}</h3>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-8 md:mt-0 text-base text-gray-400">&copy; {currentYear} Brightspyre. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
